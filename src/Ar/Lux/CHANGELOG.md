...
1.1.0 - Add gLuxAccess / gLuxAccessList to restrict which variables clients can read and write. Requires `@loupeteam/omjson` >=2.1.0. An empty list keeps the previous behavior (all variables accessible).
